...
{
    DEBUG_ASSERT((*((list_vtable_def **)list))->insert);
...
{
    ListNode ret = NULL;
    DEBUG_ASSERT((*((list_vtable_def **)list))->remove);
...
ListNode list_get(List *list, int i)
{
    ...
    DEBUG_ASSERT((*((list_vtable_def **)list))->get);
